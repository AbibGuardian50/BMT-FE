            ...
            <div class="credentials">
                <div class="card">
                    <v-card :elevation="0" max-width="350" class="">
                        <v-container>
                            <div class="logout">
                                <v-btn class="bg-red-darken-4 pa-2" variant="tonal"> <router-link to="/">Logout</router-link>
                                </v-btn>
                            </div>
                                <div class="profile-user pt-2 pb-2">
                                    <v-card class="mx-auto" max-width="350" variant="tonal">
                                        <v-card-item class="bg-grey-lighten-5 pl-2">
                                            <div>
                                                <div class=" d-flex justify-space-between text-overline mb-1 flex-column">
                                                    Profil
                            ...
                            <div class="tabungan-wajib" v-for="UserSavings in SavingsData" :key="UserSavings.id">
                                <v-card class="mx-auto pb-2" max-width="350" variant="tonal">
                                    <v-card-item class="bg-teal-lighten-3 pa-2">
                                        <div>
                                    ...
                                    <v-card-actions class="bg-teal-lighten-3">
                                        <form class="FormSaving">
                                            <v-btn variant="tonal"
                                                @click="PostPaymentMoneyLoan(UserData?.id, UserSavings.id, 'Mandatory Savings', UserSavings.nominal)"
                                                type="button">Bayar</v-btn>
                                        </form>
                                    </v-card-actions>
                                </v-card>
                            </div>
                            ...
                            <div class="pinjaman-uang" v-for="UserMoneyLoan in MoneyLoanData" :key="UserMoneyLoan.id">
                                <v-card class="mx-auto pb-2 " max-width="350" variant="tonal">
                                    <v-card-item class="bg-light-green-lighten-1 pa-2">
                                        <div>
                                            ...
                                            <div id="amount" class="text-body-2">Nominal: Rp {{
                                                UserMoneyLoan.installment_amount }}</div>
                                        </div>
                                    </v-card-item>
                                    <v-card-actions class="bg-light-green-lighten-1 pa-2">
                                        <form class="FormMoneyLoan">
                                            <v-btn variant="tonal"
                                                @click="PostPaymentMoneyLoan(UserData?.id, UserMoneyLoan.id, 'Loan Fund', UserMoneyLoan.installment_amount)"
                                                type="button">Bayar</v-btn>
                                        </form>
                                    </v-card-actions>
                                </v-card>
                            ...
                            <div class="pinjaman-barang" v-for="UserGoodsLoan in GoodsLoanData" :key="UserGoodsLoan.id">
                                <v-card class="mx-auto" max-width="350" variant="tonal">
                                    <v-card-item class="bg-lime-lighten-1 pa-2">
                                        <div>
                                    ...
                                    <v-card-actions class="bg-lime-lighten-1 pa-2">
                                        <form class="FormGoodsLoan">
                                            <v-btn variant="tonal"
                                                @click="PostPaymentMoneyLoan(UserData?.id, UserGoodsLoan.id, 'Goods Loan', UserGoodsLoan.installment_amount)"
                                                type="button">Bayar</v-btn>
                                        </form>
                                    </v-card-actions>
                                </v-card>
