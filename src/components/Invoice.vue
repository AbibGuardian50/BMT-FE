<template>
    <div class="bg-white border rounded-lg shadow-lg px-6 py-8 max-w-md mx-auto mt-8">
        ...
        <table class="w-full mb-8">
            ...
            <tbody>
                <tr>
                    <td class="text-left text-gray-700"><!-- {{ panggil API Deskripsi }} -->{{ CheckoutData?.description }}
                    </td>
                    <td class="text-right text-gray-700"><!-- {{ panggil API nominal }} --> Rp {{ CheckoutData?.nominal }}
                    </td>
                </tr>
            </tbody>
            <tfoot>
