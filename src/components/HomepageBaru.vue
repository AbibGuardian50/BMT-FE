                    ...
                    <v-card max-width="350" class="mx-auto">
                        <v-container>
                            <v-row dense>
                                ...
                                <v-col cols="12">
                                    <v-card class="pa-2" color="#385F73" theme="dark">
                                        <v-card-text>
                                            Selamat Datang
                                        </v-card-text>
                            ...
                            <v-row dense>
                                <p class="text-h6">Pinjaman Uang</p>
                                <v-col cols="12">
                                    <v-card class="pa-2" color="#385F73" theme="dark">
                                        <v-card-text>
                                            Selamat Datang
                                ...
                                <p class="text-h6">Pinjaman Barang</p>
                                <v-col cols="12">
                                    <v-card class="pa-2" color="#385F73" theme="dark">
                                        <v-card-text>
                                            Selamat Datang
...
.logo {
    background-image: url("../assets/notebook-dynamic-color.svg");
    width: 100%;
    height: 140px;
